...
namespace Pet_Shoping
{
    public partial class PetView : System.Web.UI.Page
    {
        ...
        private void BindProductDetails()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("SP_BindPetDetails1", con)
                {
        ...
        private void BindProductImage()
        {
            ...
            using (SqlConnection con = new SqlConnection(CS))
            {
                using (SqlCommand cmd = new SqlCommand("select * from tblPetImages where PID='" + PID + "'", con))
                {
        ...
        protected void btnAddtoCart_Click(object sender, EventArgs e)
        {
            ...
            //    //    Response.Cookies.Add(CartProducts);
            //    //}
            //    AddToCartProduction();// wait..
            //    Response.Redirect("PetView.aspx?PID=" + PID);
          ...
          //          using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
           ...
           //             if (dt.Rows.Count > 0)
            ...
            //                divSuccess.Visible = true;
                  ...
                  //          myCmd.Parameters.AddWithValue("@PSelPrice", Session["myPSellPrice"].ToString());
