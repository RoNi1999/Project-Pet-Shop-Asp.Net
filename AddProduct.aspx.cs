    ...
    public partial class AddProduct : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            using (SqlConnection con = new SqlConnection(CS))
            {
                ...
                cmd.Parameters.AddWithValue("@PProductDetails",txtPetDetail.Text);
                cmd.Parameters.AddWithValue("@PMaterialCare",txtPetCare.Text);
                ...
                for(int i=0; i<cblSize.Items.Count;i++)
                {
                    if(cblSize.Items[i].Selected==true)
                    {
                        ...
                        SqlCommand cmd2 = new SqlCommand("insert into tblPetSizeQuantity values('" + PID + "','" + SizeID + "','" + Quantity + "')", con);
                ...
                if(fuImg01.HasFile)
                {
                    ...
                    fuImg01.SaveAs(SavePath + "//" + txtPetName.Text.ToString().Trim() + "01" + Extention);

                    SqlCommand cmd3 = new SqlCommand("insert into tblPetImages values('" + PID + "','" + txtPetName.Text.ToString().Trim() +"01"+ "','" + Extention + "')", con);
                ...
                if (fuImg02.HasFile)
                {
                    ...
                    string Extention = Path.GetExtension(fuImg01.PostedFile.FileName);
                    fuImg02.SaveAs(SavePath + "//" + txtPetName.Text.ToString().Trim() + "02" + Extention);

                    SqlCommand cmd4 = new SqlCommand("insert into tblPetImages values('" + PID + "','" + txtPetName.Text.ToString().Trim() + "02" + "','" + Extention + "')", con);
                ...
                if (fuImg03.HasFile)
                {
                    ...
                    string Extention = Path.GetExtension(fuImg01.PostedFile.FileName);
                    fuImg03.SaveAs(SavePath + "//" + txtPetName.Text.ToString().Trim() + "03" + Extention);

                    SqlCommand cmd5 = new SqlCommand("insert into tblPetImages values('" + PID + "','" + txtPetName.Text.ToString().Trim() + "03" + "','" + Extention + "')", con);
                ...
                if (fuImg04.HasFile)
                {
                    ...
                    string Extention = Path.GetExtension(fuImg01.PostedFile.FileName);
                    fuImg04.SaveAs(SavePath + "//" + txtPetName.Text.ToString().Trim() + "04" + Extention);

                    SqlCommand cmd6 = new SqlCommand("insert into tblPetImages values('" + PID + "','" + txtPetName.Text.ToString().Trim() + "04" + "','" + Extention + "')", con);
                ...
                if (fuImg05.HasFile)
                {
                    ...
                    string Extention = Path.GetExtension(fuImg01.PostedFile.FileName);
                    fuImg05.SaveAs(SavePath + "//" + txtPetName.Text.ToString().Trim() + "05" + Extention);

                    SqlCommand cmd7 = new SqlCommand("insert into tblPetImages values('" + PID + "','" + txtPetName.Text.ToString().Trim() + "05" + "','" + Extention + "')", con);
