<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="PetView.aspx.cs" Inherits="Pet_Shoping.PetView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item<%-- <%# GetActiveImgClass(Container.ItemIndex) %>">--%>
      <img src="Images/<%# Eval("PID") %>/<%# Eval("Name") %><%# Eval("Extention") %>" alt="<%# Eval("Name") %>" onerror="this.src='Images/ImageNotAvailable.jpg'">
    ...
    <span class="sr-only">Next</span>
        ...
        <div class="col-md-5">
            ...
            <div class="divDet1">
                ...
                <span class="proOgPriceView">Rs.<%#Eval("PPrice","{0:c}") %></span> <span class="proPriceDiscountView"> Off Rs.<%# string.Format("{0}",Convert.ToInt64(Eval("PPrice"))-Convert.ToInt64(Eval("PSellPrice"))) %></span><p class="proPriceView">Rs. <%#Eval("PSellPrice","{0:c}") %></p>
            </div>
            <div >
                <h5 class="h5size"> SIZE</h5>
                <div>
                    <asp:radiobuttonlist ID="rblSize" runat="server" RepeatDirection="Horizontal" >
                        <asp:ListItem Value="Baby" Text="Baby"></asp:ListItem>
