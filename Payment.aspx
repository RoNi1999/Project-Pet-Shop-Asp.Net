<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="Pet_Shoping.Payment" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:HiddenField ID="hdPetAmount" runat="server" />
    <asp:HiddenField ID="hdPetDiscount" runat="server" />
    ...
    <button id="btnCart2" runat="server" class="btn btn-primary navbar-btn pull-right" onserverclick="btnCart2_ServerClick" type="button">
                        Pet <span id="CartBadge" runat="server" class="badge">0</span>
                    </button>
    <br />
    <div class="row" style="padding-top: 20px;">
        ...
        <div class="col-md-9">
             ...
             <div>
                                <asp:GridView ID="gvPet" runat="server" CssClass="col-md-12"  AutoGenerateColumns="false" Visible="false" CellPadding="6"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="PID" HeaderText="Pet ID" />
                                        <asp:BoundField DataField="PName" HeaderText="Pet Name" />
